...
using (var client = new HttpClient()) {
    ...
    foreach ( var m in myMeasures)
    {
        ...
        "{" +
        "\"role\": \"system\"," +
        "\"content\": \"You are Power BI and business expert. Your task is to explain the DAX calculation in a few sentences in simple business terms without using DAX function names. It need to understand people who are not familiar with the data model and DAX." + 
