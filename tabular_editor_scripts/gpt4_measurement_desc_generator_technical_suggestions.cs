...
using (var client = new HttpClient()) {
    ...
    foreach ( var m in myMeasures)
    {
        ...
        "{" +
        "\"role\": \"system\"," +
        "\"content\": \"You are Power BI expert. Your task is to explain the DAX calculation in a few sentences with technical aspects. Please give advices, refactor ideas if you have some major, impactful observations." + 
